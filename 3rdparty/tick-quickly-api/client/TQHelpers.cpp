...
public:
    ...
    static TQSerializerSettings *getInstance(){
        if(instance == nullptr){
            instance = new TQSerializerSettings();
        }
        return instance;
    }

private:
    explicit TQSerializerSettings(){
        instance = this;
        customDateTimeFormat.isStringSet = false;
        customDateTimeFormat.isEnumSet = false;
    }
    static TQSerializerSettings *instance;
    CustomDateTimeFormat customDateTimeFormat;
};

TQSerializerSettings * TQSerializerSettings::instance = nullptr;
...
bool setDateTimeFormat(const QString &dateTimeFormat){
    ...
    if (dt.isValid()) {
        success = true;
        TQSerializerSettings::setDateTimeFormatString(dateTimeFormat);
    }
    return success;
}
...
bool setDateTimeFormat(const Qt::DateFormat &dateTimeFormat){
    ...
    if (dt.isValid()) {
        success = true;
        TQSerializerSettings::setDateTimeFormatEnum(dateTimeFormat);
    }
    return success;
}
...
QString toStringValue(const QDateTime &value) {
    if (TQSerializerSettings::getInstance()->getCustomDateTimeFormat().isStringSet) {
        return value.toString(TQSerializerSettings::getInstance()->getCustomDateTimeFormat().formatString);
    }

    if (TQSerializerSettings::getInstance()->getCustomDateTimeFormat().isEnumSet) {
        return value.toString(TQSerializerSettings::getInstance()->getCustomDateTimeFormat().formatEnum);
    }
...
QString toStringValue(const TQObject &value) {
    return value.asJson();
}

QString toStringValue(const TQEnum &value) {
    return value.asJson();
}

QString toStringValue(const TQHttpFileElement &value) {
    return value.asJson();
}
...
QJsonValue toJsonValue(const QDateTime &value) {
    if (TQSerializerSettings::getInstance()->getCustomDateTimeFormat().isStringSet) {
        return QJsonValue(value.toString(TQSerializerSettings::getInstance()->getCustomDateTimeFormat().formatString));
    }

    if (TQSerializerSettings::getInstance()->getCustomDateTimeFormat().isEnumSet) {
        return QJsonValue(value.toString(TQSerializerSettings::getInstance()->getCustomDateTimeFormat().formatEnum));
    }
...
QJsonValue toJsonValue(const TQObject &value) {
    return value.asJsonObject();
}

QJsonValue toJsonValue(const TQEnum &value) {
    return value.asJsonValue();
}

QJsonValue toJsonValue(const TQHttpFileElement &value) {
    return value.asJsonValue();
}
...
bool fromStringValue(const QString &inStr, QDateTime &value) {
    if (inStr.isEmpty()) {
       ...
       QDateTime dateTime;
        if (TQSerializerSettings::getInstance()->getCustomDateTimeFormat().isStringSet) {
            dateTime = QDateTime::fromString(inStr, TQSerializerSettings::getInstance()->getCustomDateTimeFormat().formatString);
        } else if (TQSerializerSettings::getInstance()->getCustomDateTimeFormat().isEnumSet) {
            dateTime = QDateTime::fromString(inStr, TQSerializerSettings::getInstance()->getCustomDateTimeFormat().formatEnum);
        } else {
...
bool fromStringValue(const QString &inStr, TQObject &value)
{
    QJsonParseError err;
...
bool fromStringValue(const QString &inStr, TQEnum &value) {
    value.fromJson(inStr);
    return true;
}

bool fromStringValue(const QString &inStr, TQHttpFileElement &value) {
...
bool fromJsonValue(QDateTime &value, const QJsonValue &jval) {
    ...
    if (!jval.isUndefined() && !jval.isNull() && jval.isString()) {
        if (TQSerializerSettings::getInstance()->getCustomDateTimeFormat().isStringSet) {
            value = QDateTime::fromString(jval.toString(), TQSerializerSettings::getInstance()->getCustomDateTimeFormat().formatString);
        } else if (TQSerializerSettings::getInstance()->getCustomDateTimeFormat().isEnumSet) {
            value = QDateTime::fromString(jval.toString(), TQSerializerSettings::getInstance()->getCustomDateTimeFormat().formatEnum);
        } else {
...
bool fromJsonValue(TQObject &value, const QJsonValue &jval) {
    bool ok = true;
    if (jval.isObject()) {
...
bool fromJsonValue(TQEnum &value, const QJsonValue &jval) {
    value.fromJsonValue(jval);
    return true;
}

bool fromJsonValue(TQHttpFileElement &value, const QJsonValue &jval) {
