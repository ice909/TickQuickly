...
#ifndef TQ_HTTP_FILE_ELEMENT_H
#define TQ_HTTP_FILE_ELEMENT_H
...
Q_DECLARE_METATYPE(TickQuicklyAPI::TQHttpFileElement)

#endif // TQ_HTTP_FILE_ELEMENT_H
